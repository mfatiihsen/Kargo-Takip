...
public class aras extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aras);

        AdView adView = new AdView(this);
        adView.setAdSize(AdSize.BANNER);
        adView.setAdUnitId("ca-app-pub-4365766653931652/3216393263");
        ...
        // toolbar tanımlama ve toolbar geri butonu işlemi
        toolbar = (Toolbar) findViewById(R.id.toolbar_aras);
        setSupportActionBar(toolbar);
        toolbar.setTitle("ARAS Kargo");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        surat = (RelativeLayout) findViewById(R.id.surat_layout);
        webView = (WebView) findViewById(R.id.web_view_aras);
        ...
        webView.loadUrl("https://www.araskargo.com.tr/trmobile/");


        // yükleme methodunun çağırılması
        Prog();
    }
