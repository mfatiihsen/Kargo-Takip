...
public class yurt_ici extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yurt_ici);


        AdView adView = new AdView(this);
        adView.setAdSize(AdSize.BANNER);
        adView.setAdUnitId("ca-app-pub-4365766653931652/9973373309");
        ...
        toolbar.setTitle("Yurt İçi Kargo");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        webView = (WebView) findViewById(R.id.web_view_ups);
        ...
        webView.loadUrl("https://www.yurticikargo.com/");

        Prog();
        surat = (RelativeLayout) findViewById(R.id.surat_layout);
        webView = (WebView) findViewById(R.id.web_view_surat);
    }
