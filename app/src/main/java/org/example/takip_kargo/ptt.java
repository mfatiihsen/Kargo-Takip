...
public class ptt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adView.setAdUnitId("ca-app-pub-4365766653931652/7347209964");
        ...
        toolbar.setTitle("PTT Kargo");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        webView = (WebView) findViewById(R.id.web_view_ptt);
        ...
        webView.loadUrl("https://gonderitakip.ptt.gov.tr/");
